...
module Aparcamiento
  ...
  class Parking
    ...
    def initialize(accesibilidad, seguridad, identificacion, nombre_comercial, descripcion, tipo, conjunto_plazas, conjunto_plazas_libre, conjunto_plazas_ocupadas)
      ...
      # Devuelve el numero de plazas que hay en el aparcamiento, el tamaño del array de conjunto_plazas
      def numero_plazas
        return @conjunto_plazas.length
      end

      # Este método devuelve el número de plazas libres en el aparcamiento
      # Devuelve un numero entero que representa el numero de plazas libres
      # Lo que hace es recorrer el array conjunto_plazas, que es lo que se le pasa por parametros 
      # a la funcion y busca el parametro estado_plazas y busca el valor :libre y si lo encuentra
      # añade +1 al contador
