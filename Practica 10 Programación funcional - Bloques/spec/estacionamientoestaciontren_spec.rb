...
RSpec.describe Aparcamiento do
  ...
  describe Aparcamiento::EstacionamientoEstacionTren do
    context "Creacion de objetos de la clase EstacionamientoEstacionTren, test de errores y expectativas" do
      it "Se crea un objeto de la clase EstacionamientoEstacionTren" do
        expect(Aparcamiento::EstacionamientoEstacionTren).not_to eq(nil)
      end
    ...
    context "Herencia de la clase EstacionamientoEstacionTren" do
      it "Testeo de la instancia de objetos sea de tipo 'EstacionamientoEstacionTren'" do
        estacion_trinidad = Aparcamiento::EstacionamientoEstacionTren.new(2, 15.0, 20, 0.005, @conjunto_vehiculos_1, 4, 9, 999999, "Estacion Trinidad", :mixto, :coches, @conjunto_plazas, @conjunto_plazas_libre, @conjunto_plazas_ocupadas)
        expect(estacion_trinidad.is_a?Aparcamiento::EstacionamientoEstacionTren).to eq(true)
      end

      it "Testeo de la instancia de objetos sea de tipo 'Parking'" do
        estacion_trinidad = Aparcamiento::EstacionamientoEstacionTren.new(2, 15.0, 20, 0.005, @conjunto_vehiculos_1, 4, 9, 999999, "Estacion Trinidad", :mixto, :coches, @conjunto_plazas, @conjunto_plazas_libre, @conjunto_plazas_ocupadas)
        expect(estacion_trinidad.is_a?Aparcamiento::Parking).to eq(true)
      end 

      it "Testeo de la instancia de objetos sea de tipo 'Object'" do
        estacion_trinidad = Aparcamiento::EstacionamientoEstacionTren.new(2, 15.0, 20, 0.005, @conjunto_vehiculos_1, 4, 9, 999999, "Estacion Trinidad", :mixto, :coches, @conjunto_plazas, @conjunto_plazas_libre, @conjunto_plazas_ocupadas)
        expect(estacion_trinidad.is_a?Object).to eq(true)
      end

      it "Testeo de la instancia de objetos sea de tipo 'BasicObject'" do
        estacion_trinidad = Aparcamiento::EstacionamientoEstacionTren.new(2, 15.0, 20, 0.005, @conjunto_vehiculos_1, 4, 9, 999999, "Estacion Trinidad", :mixto, :coches, @conjunto_plazas, @conjunto_plazas_libre, @conjunto_plazas_ocupadas)
        expect(estacion_trinidad.is_a?BasicObject).to eq(true)
      end
    end
  end
end