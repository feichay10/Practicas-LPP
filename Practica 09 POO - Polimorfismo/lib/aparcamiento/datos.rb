...
module Aparcamiento
  ...
  class Datos
    include Funciones
    attr_reader :accesibilidad, :seguridad, :identificacion, :nombre_comercial, :descripcion, :conjunto_plazas, :conjunto_plazas_libre, :conjunto_plazas_ocupadas
    def initialize(accesibilidad, seguridad, identificacion, nombre_comercial, descripcion, conjunto_plazas, conjunto_plazas_libre, conjunto_plazas_ocupadas)
